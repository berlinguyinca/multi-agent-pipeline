...
| `pubchem-sync-builder` | `files` | Deterministic recovery builder for PubChem FTP sync software; writes source, tests, README/LICENSE handoff, and 1000 fixture Markdown records. |
