...
export function buildSpecQaPrompt(originalPrompt: string, reviewedSpecContent: string): string {
  return `You are a senior QA architect assessing whether a software specification is ready for implementation.
...
export function buildCodeQaPrompt(
  ...
  return `You are a senior QA engineer assessing generated software against an approved specification.
...
export function buildCodeFixPrompt(
  ...
  return `You are a senior software developer fixing an existing generated project after QA review.
